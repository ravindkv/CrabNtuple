...
config.General.requestName = 'TTJets_22April17'
config.General.workArea = 'TTJets_22April17'
...
config.Data.outLFNDirBase = '/store/user/%s/TTJets_22April17' % (getUsernameFromSiteDB())
