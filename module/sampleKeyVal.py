...
def getLFNDirBaseMC(lable, mc, m):
    outLFNDirBase = '/store/user/rverma/multiCrab_v1/'+ lable+ '/'+getMCKey(mc, m)+"_"+ lable
    return outLFNDirBase

def getLFNDirBaseData(lable, data, m):
    outLFNDirBase = '/store/user/rverma/multiCrab_v1/'+ lable+ '/'+getDataKey(data, m)+"_"+ lable
    return outLFNDirBase
...
def getNtupleT2Paths(lable, samp, n):
    ...
    t2user_dir = '/store/user/rverma/multiCrab_v1/'
